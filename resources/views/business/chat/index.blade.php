                ...
                <div class="panel panel-flat chat-lists">
                    ...
                    <div class="col-md-4 chat-left-box">
                        <div class="left">
                            ...
                            <ul class="people" onscroll="scrollUser(this)">
...
<script>
    ...
    var urlSendNotification = '{{route('Business::chat@sendNotification')}}';
    var token = '{{ csrf_token() }}';
    var urlUpload = '{{route('Ajax::Staff::upload@image')}}';
    var urlSearchGtin  = '{{route('Business::chat@searchGtin')}}';
    var icheckID = '{{$icheck_id}}';
...
<script src="{{url('assets-chat-dn/js/firebase.js')}}"></script>
<script src="{{url('/js/icheckio.js')}}"></script>
{{--<script src="https://www.gstatic.com/firebasejs/3.6.2/firebase-database.js"></script>--}}
<script src="{{url('assets-chat-dn/js/moment-with-locales.min.js')}}"></script>
...
<script src="{{url('assets-chat-dn/js/main.js')}}"></script>
    ...
    $(function () {
        $("#tags").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "{{route('Business::chat@search')}}",
                    dataType: "json",
                    data: {
                        term: request.term
                    },
...
//                    firebase.database().ref('users/'+icheck_id).on('child_changed',function(snapshot){
//
