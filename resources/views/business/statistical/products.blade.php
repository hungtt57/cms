    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                            ...
                            {{--<div class="row">--}}
                                {{--<div class="form-group">--}}
                                    {{--<div class="input-group">--}}
                                        {{--<input class="form-control" type="text" value="{{$search}}" name="search" placeholder="Search" />--}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" action="{{Request::fullUrl()}}">

                            <!-- Search Field -->
                            <div class="col-md-5 col-md-offset-7">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" id="key-search" type="text" value="{{$search}}" name="search" placeholder="Search" />
                                        <span class="input-group-btn">
                      <button type="submit" class="btn-search btn btn-success btn-xs" data-toggle="modal" data-target="#edit-pro">Search</button>
                ...
                <div class="row">
                    ...
                    $comment = 0;
                                        ...
                                        @foreach($gtins as $key => $value)
                                            ...
                                            <tr role="row">
                                                <td>@if($value['image'])
                                                        <img src="{{get_image_url($value['image'],'thumb_small')}}" alt="">
                                                    @endif</td>
                                                <td><a href="{{route('Business::getReportProduct',[$key])}}"> {{$key}}</a></td>
                                                <td>{{$value['name']}}</td>
                                                <td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var url = '{{route('Business::statistical@getChartData')}}';
