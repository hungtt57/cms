            ...
            <div class="col-md-12">
                <section class="panel">
                    ...
                    <header class="panel-heading">
                        <a href="{{url('admin/tournaments')}}">Tournaments</a>&nbsp;/&nbsp;Create a New Tournament
                    </header>
                    <!-- End of Panel Header -->
                    <!-- Panel body -->
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                ...
                                <form enctype='multipart/form-data' name='bar_create_form' action="{{route('tournaments.store')}}" method='post'>
                                    {{ csrf_field() }}

                                    <div class="form-group">
                                        <label for="id_name">Name</label>
                                        <input type="text" class="form-control f3" id="id_name" name="name" value="{{old('name')}}" placeholder="Enter Name of Tournament">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control f3" id="id_suffix" name="suffix" value="{{old('suffix')}}" placeholder="Enter Year/Season">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="id_description" name="description" rows="3">{{old('description')}}</textarea>
