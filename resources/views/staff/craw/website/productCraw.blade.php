    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                ...
                <h2>
                    <a href="#" onclick="return back()" class="btn btn-link">
                        <i class="icon-arrow-left8"></i>
                    </a>
                    Chi tiết sản phẩm của website : {{@$website->name}}</h2>
            </div>
                                    ...
                                    {{--<td>--}}
                                        {{--<div class="dropdown">--}}
                                            ...
                                            {{--<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="product-{{ $w->id }}-actions">--}}
                                                ...
                                                {{--<li><a href="{{ route('Staff::Craw::website@edit', [$w->id]) }}"><i class="icon-pencil5"></i> Sửa</a></li>--}}
                                                {{--<li><a href="{{ route('Staff::Craw::website@delete', [$w->id]) }}"><i class="icon-pencil5"></i> Xóa</a></li>--}}
