      ...
      <div class="content-wrapper">
        <div class="panel panel-flat">
          <div class="panel-body">
            ...
            <form method="POST" action="{{ route('Staff::Management::productReview@group@update', [$group->id]) }}">
              {{ csrf_field() }}
              ...
              <div class="form-group {{ $errors->has('max_review') ? 'has-error has-feedback' : '' }}">
                ...
                <input type="text" id="max-review" name="max_review" class="form-control" value="{{ @$group->max_review }}" />
                @if ($errors->has('name'))
