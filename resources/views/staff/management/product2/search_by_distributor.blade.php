  ...
  <div class="page-header">
    <div class="page-header-content">
      <div class="page-title">
        <h2>Sản phẩm theo nhà phân phối</h2>
      </div>
      ...
      <div class="content-wrapper">
          ...
          <form role="form">
              <div class="form-group">
                  <select name="distributor" class="form-control js">
                    @foreach ($distributors as $distributor)
                    <option  @if(Request::get('distributor') == $distributor->id) selected @endif value="{{ $distributor->id }}">{{ $distributor->name }}</option>
                    @endforeach
                  </select>
              </div>
              <div class="form-group">
