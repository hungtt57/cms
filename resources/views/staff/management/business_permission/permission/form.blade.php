    ...
    <div class="page-header-content">
      <div class="page-title">
        <h2>
          ...
          {{ isset($permission) ? 'Sửa  quyền DN' : 'Thêm quyền DN' }}
        </h2>
      </div>
    </div>
  </div>
          ...
          <div class="col-md-offset-2 col-md-8">
            ...
            <div class="panel panel-flat">
              <div class="panel-body">
                <form method="POST" enctype="multipart/form-data" action="{{ isset($permission) ? route('Staff::Management::businessPermission@permission@update', [$permission->id] ): route('Staff::Management::businessPermission@permission@store') }}">
                  {{ csrf_field() }}
                  @if (isset($permission))
