                        ...
                        <div class="panel panel-flat">
                            <div class="panel-body">
                                ...
                                <!---------- Name------------>
                                    ...
                                    @if (auth('staff')->user()->can('add-new-sales'))
                                        @php
                                            $role_sales = \App\Models\Enterprise\Role::where('name','Like','SALES')->first();
                                    ...
                                    <div class="form-group {{ $errors->has('manager_id') ? 'has-error has-feedback' : '' }}">
                                        ...
                                        <select id="country" name="manager_id"  class="select-border-color border-warning js-manager-select">
                                            ...
                                            @foreach ($managers as $manager)
                                                @if(isset($user) and $manager->id != $user->id)
                                                <option value="{{ $manager->id }}" {{ (isset($user) and $user->manager_id and $user->manager_id == $manager->id) ? ' selected="selected"' : '' }}>{{ $manager->email }}</option>
                                                @endif
                                            @endforeach
                                        </select>
