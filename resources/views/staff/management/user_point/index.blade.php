    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <h5>Tổng điểm hệ thống đã cấp : {{floatval($total_point->point)}}</h5>
                    <h5>Tổng số User được điểm : {{count($total_user)}}</h5>
                </div>
                <div class="row">
                                ...
                                <div class="panel panel-flat">
                                    <table class="table table-hover">
                                        ...
                                        @foreach($user_points as $user_point)
                                            ...
                                            <tr>
                                                <td><a href="{{route('Staff::Management::userPoint@detailDay',$user_point->date)}}">{{$user_point->date}}</a></td>
                                                <td>{{intval($user_point->point)}}</td>
                ...
                <div class="row" style="text-align: right">
                    {!! $user_points->appends(Request::all())->links() !!}
                </div>
