    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h2>
                    Thống kê chỉ số Google Analytics
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="row mb-20">
                    ...
                    <div class="col-md-6">
                        <h4>Ngay bây giờ có : <b>{{$realtime_user}}</b> người đang hoạt động</h4>
                    </div>
                </div>
                <form class="mb-20">
...
<script>
    $(document).ready(function () {
        ...
        $('#chart_container').highcharts({
            ...
            series: [{
                name: 'NRU',
                data:{{ json_encode($chartData['new_user'])}}
            },
                {
                    name: 'DAU',
                    data:{{ json_encode($chartData['daily_users'])}}
                }]
        });
