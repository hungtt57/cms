    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h2>
                    Thống kê số lượng bài viết và comment trên mạng xã hội
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat panel-body">
                    <div id="chart_container_post"></div>
                </div>
                <div class="panel panel-flat panel-body">
                    <div id="chart_container_comment"></div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#chart_container_post').highcharts({
            chart: {
                type: 'spline'
            },
            title: {
            ...
            series: [{
                name: 'Bài Viết',
                data: {{json_encode($chartData['post'])}}
            }]
        });

        $('#chart_container_comment').highcharts({
            chart: {
                type: 'spline'
            },
            title: {
