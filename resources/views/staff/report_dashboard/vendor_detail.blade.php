        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                                ...
                                <div class="panel panel-flat">
                                    <table class="table table-hover">
                                        ...
                                        @foreach($products as $product)
                                            @php $key = $product->gtin_code; @endphp
                                            <tr>
                                                <td><img width="100" src="{{get_image_url($product->image_default)}}" alt=""></td>
                    ...
                    <div style="float:right;">{!!$products->appends(Request::all())->render()!!}</div>
                </div>
