...
class LikeController extends Controller
{
    ...
    {
        if (auth()->guard('staff')->user()->cannot('analytics-like')) {
            abort(403);
        }
        ...
        return view('staff.analytics.like', compact('startDate', 'endDate', 'gln', 'products', 'chartData', 'tableData', 'selectedGln', 'selectedGtin'));
    }
}
