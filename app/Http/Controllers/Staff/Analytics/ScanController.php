...
class ScanController extends Controller
{
    ...
    {
        if (auth()->guard('staff')->user()->cannot('analytics-scan')) {
            abort(403);
        }
        ...
        return view('staff.analytics.scan', compact('startDate', 'endDate', 'gln', 'products', 'chartData', 'tableData', 'selectedGln', 'selectedGtin'));
    }
}
