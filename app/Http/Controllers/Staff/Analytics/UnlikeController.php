...
class UnlikeController extends Controller
{
    ...
    {
        if (auth()->guard('staff')->user()->cannot('analytics-unlike')) {
            abort(403);
        }
        ...
        return view('staff.analytics.unlike', compact('startDate', 'endDate', 'gln', 'products', 'chartData', 'tableData', 'selectedGln', 'selectedGtin'));
    }
}
