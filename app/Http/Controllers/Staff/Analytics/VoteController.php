...
class VoteController extends Controller
{
    ...
    {
        if (auth()->guard('staff')->user()->cannot('analytics-vote')) {
            abort(403);
        }
        ...
        return view('staff.analytics.vote', compact('startDate', 'endDate', 'gln', 'products', 'chartData', 'tableData', 'selectedGln', 'selectedGtin'));
    }
}
